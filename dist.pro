...
blambda=2.0*6.63e-27*(3.0e10)^2/lambda^5/ $
  (exp(6.63e-27*3.0e10/lambda/1.38e-16/10000.0)-1.0)
...
for j=0,999 do begin
    blambdad[j,*]=2.0*6.63e-27*(3.0e10)^2/lambda^5/ $
      (exp(6.63e-27*3.0e10/lambda/1.38e-16/t[j])-1.0)
